...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayMonan.add(new MonAn("Thumbnail 1", R.drawable.first));
        arrayMonan.add(new MonAn("Thumbnail 2", R.drawable.second));
        arrayMonan.add(new MonAn("Thumbnail 3", R.drawable.third));
        arrayMonan.add(new MonAn("Thumbnail 4", R.drawable.fourth));
        arrayMonan.add(new MonAn("Thumbnail 5", R.drawable.fifth));
